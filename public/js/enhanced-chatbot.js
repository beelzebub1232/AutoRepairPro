...
class EnhancedChatbot {
    ...
    createChatbotInterface() {
        ...
        const chatbotHTML = `
            <div id="enhanced-chatbot-container" class="enhanced-chatbot-container">
                <div id="chatbot-toggle" class="enhanced-chatbot-toggle">
                    <div class="chatbot-icon">🤖</div>
                    <div class="chatbot-pulse"></div>
                </div>
                <div id="chatbot-window" class="enhanced-chatbot-window">
                    <div class="chatbot-header">
                        <div class="chatbot-avatar">🤖</div>
                        <div class="chatbot-info">
                            <h4>AutoRepairPro Assistant</h4>
                    ...
                    <div id="chatbot-messages" class="enhanced-chatbot-messages">
    ...
    getWelcomeMessage() {
        ...
        const messages = {
            admin: {
                text: `Hello ${name}! I'm your AutoRepairPro assistant. I can help you with managing operations, viewing reports, and system administration.`,
        ...
        return messages[role] || {
            text: "Hello! I'm your AutoRepairPro assistant. How can I help you today?",
    ...
    saveConversationHistory() {
        localStorage.setItem('chatbot_history', JSON.stringify(this.conversationHistory.slice(-50))); // Keep last 50 messages
    }
